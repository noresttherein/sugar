...
import net.noresttherein.slang.Sealing.NotSealed
...
/** Utilities which simulate the functionality of the `sealed` modifier for declarations such as `def`, `val` and `var`,
  ...
  * [[net.noresttherein.slang.Sealing.Seal Seal]] and a value class [[net.noresttherein.slang.Sealing.Sealed Sealed]]`[T]`
...
trait Sealing {
	...
	/** An artificial class used to prevent overriding of a method by classes outside of the visibility scope
	  ...
	  * declarations. For this purpose a [[net.noresttherein.slang.Sealing.Sealed Sealed]]`[T]` wrapper value class
	...
	/** A value wrapper with visibility restricted to the same as the enclosing
	  *  [[net.noresttherein.slang.Sealing Sealing]] instance, essentially limiting the visibility of declarations
	  ...
	  *  but for methods a sibling class [[net.noresttherein.slang.Sealing.Seal Seal]] will typically be more convenient.
	  */
