...
import net.noresttherein.slang.extensions.iterableFactoryExtension
...
//		new MappingMethods[Array, E](new ArrayIterableOps(self))
	...
	/** Additional, higher level factory methods of any [[Iterable]] type `C[_]` as extensions of its companion
	  ...
	  * Adds methods [[net.noresttherein.slang.collection.IterableFactoryExtension.expand expand]]
	  * and [[net.noresttherein.slang.collection.IterableFactoryExtension.generate generate]]
	...
	/** An extension method [[net.noresttherein.slang.collection.BuilderExtension.mapInput mapElements]]
...
class FoldingMethods[T](private val items :IterableOnce[T]) extends AnyVal {
	/** Folds this collection until the folded value satisfies the condition `pred`.
	  ...
	  * to `this.`[[net.noresttherein.slang.collection.foldingMethods.foldWhile foldWhile]]`(start)(!pred(_))(op)`,
	  ...
	  *         to [[net.noresttherein.slang.collection.foldingMethods.foldLeftUntil]]`(start)(pred)(op)`.
	  */
	...
	/** Folds this collection until the folded value satisfies the condition `pred`.
	  ...
	  * to `this.`[[net.noresttherein.slang.collection.foldingMethods.foldWhileOpt foldWhileOpt]]`(start)(!pred(_))(op)`,
	  * as the latter will return the last element for which `pred` was not satisfied, while this method
	  * applies `op` once more.
	  * @param start the initial value, used as the result if the collection is empty.
	  * @param pred  a stop condition for folding, checked first for `start`, and then for every result
	  ...
	  * @param op    a folding function.
	  * @return This implementation delegates
	  *         to [[net.noresttherein.slang.collection.foldingMethods.foldLeftUntilOpt]]`(start)(pred)(op)`
	  */
	...
	/** Folds this collection until the folded value satisfies the condition `pred`.
	  ...
	  *
	  * It is not equivalent
	  * to `this.`[[net.noresttherein.slang.collection.foldingMethods.foldWhileEither foldWhileEither]]`(start)(!pred(_))(op)`,
	  * as the latter will return the last element for which `pred` was not satisfied, while this method
	  * applies `op` once more.
	  * @param start the initial value, used as the result if the collection is empty.
	  * @param pred  a stop condition for folding, checked first for `start`, and then for every result
	  ...
	  * @param op    a folding function.
	  * @return This implementation delegates
	  *         to [[net.noresttherein.slang.collection.foldingMethods.foldLeftUntilEither]]`(start)(pred)(op)`
	  */
	...
	/** Folds this collection from left to right by applying `op` to its elements and the previously returned value
	  ...
	  * [[net.noresttherein.slang.collection.foldingMethods.foldLeftWhile foldLeftWhile]]`(start)(!pred(_))(op)`,
	  * as the latter will return the last element for which `pred` was not satisfied, while this method
	  * applies `op` once more.
	  * @param start the initial value, used as the result if the collection is empty.
	  * @param pred  a stop condition for folding, checked first for `start`, and then for every result
	...
	/** Folds this collection from left to right by applying `op` to its elements and the previously returned value
	  ...
	  * }}}
	  * It is not equivalent to
	  * [[net.noresttherein.slang.collection.foldingMethods.foldLeftWhileOpt foldLeftWhileOpt]]`(start)(!pred(_))(op)`,
	  * as the latter will return the last element for which `pred` was not satisfied, while this method
	  * applies `op` once more.
	  * @param start the initial value, used as the result if the collection is empty.
	  * @param pred  a stop condition for folding, checked first for `start`, and then for every result
	...
	/** Folds this collection from left to right by applying `op` to its elements and the previously returned value,
	  ...
	  * }}}
	  * It is not equivalent to
	  * [[net.noresttherein.slang.collection.foldingMethods.foldLeftWhileEither foldLeftWhileEither]]`(start)(!pred(_))(op)`,
	  * as the latter will return the last element for which `pred` was not satisfied, while this method
	  * applies `op` once more.
	  * @param start the initial value, used as the result if the collection is empty.
	  * @param pred  a stop condition for folding, checked first for `start`, and then for every result
...
//				rec(start, inverse)
	...
	/** Folds this collection from right to left by applying `op` to its elements and the previously returned value
	  ...
	  * }}}
	  * It is not equivalent to
	  * [[net.noresttherein.slang.collection.foldingMethods.foldRightWhile foldRightWhile]]`(start)(!pred(_))(op)`,
	  * as the latter will return the last element for which `pred` was not satisfied, while this method
	  * applies `op` once more.
	  * @param start the initial value, used as the result if the collection is empty.
	  * @param pred  a stop condition for folding, checked first for `start`, and then for every result
	...
	/** Folds this collection from right to left by applying `op` to its elements and the previously returned value
	  ...
	  * }}}
	  * It is not equivalent to
	  * [[net.noresttherein.slang.collection.foldingMethods.foldRightWhileOpt foldRightWhileOpt]]`(start)(!pred(_))(op)`,
	  * as the latter will return the last element for which `pred` was not satisfied, while this method
	  * applies `op` once more.
	  * @param start the initial value, used as the result if the collection is empty.
	  * @param pred  a stop condition for folding, checked first for `start`, and then for every result
	...
	/** Folds this collection from left to right by applying `op` to its elements and the previously returned value,
	  ...
	  * }}}
	  * It is not equivalent to
	  * [[net.noresttherein.slang.collection.foldingMethods.foldRightWhileEither foldRightWhileEither]]`(start)(!pred(_))(op)`,
	  * as the latter will return the last element for which `pred` was not satisfied, while this method
	  * applies `op` once more.
	  * @param start the initial value, used as the result if the collection is empty.
	  * @param pred  a stop condition for folding, checked first for `start`, and then for every result
	...
	/** Folds this collection from left to right by applying `op` to its elements and the previously returned value
	  ...
	  * [[net.noresttherein.slang.collection.foldingMethods.foldLeftUntil foldLeftUntil]]`(start)(!pred(_))(op)`,
	...
	/** Folds this collection from left to right by applying `op` to its elements and the previously returned value
	  ...
	  * }}}
	  * Note that this method is ''not'' equivalent to
	  * [[net.noresttherein.slang.collection.foldingMethods.foldLeftUntilOpt foldLeftUntilOpt]]`(start)(!pred(_))(op)`,
	  * as the latter returns the first element of `numbers.scanLeft(start)(op)` falsifying the predicate,
	  * while this method returns the last element for which it is still true.
	  * @param start the initial value, used as the result if the collection is empty.
	  * @param pred  a stop condition for folding, checked for the folded value at the beginning of every iteration.
	...
	/** Folds this collection from left to right by applying `op` to its elements and the previously returned value
	  ...
	  * }}}
	  * Note that this method is ''not'' equivalent to
	  * [[net.noresttherein.slang.collection.foldingMethods.foldLeftUntilEither foldLeftUntilEither]]`(start)(!pred(_))(op)`,
	  * as the latter returns the first element of `numbers.scanLeft(start)(op)` falsifying the predicate,
	  * while this method returns the last element for which it is still true.
	  * @param start the initial value, used as the result if the collection is empty.
	  * @param pred  a stop condition for folding, checked for the folded value at the beginning of every iteration.
...
//				ifFound(last)
	...
	/** Folds this collection from right to left by applying `op` to its elements and the previously returned value
	  ...
	  * }}}
	  * Note that this method is ''not'' equivalent to
	  * [[net.noresttherein.slang.collection.foldingMethods.foldRightUntil foldRightUntil]]`(start)(!pred(_))(op)`,
	...
	/** Recursively applies the given partial function to the elements of this collection and a folded value,
	  ...
	  * @return [[net.noresttherein.slang.collection.foldingMethods.partialFoldLeft partialFoldLeft]]`(start)(op)`.
	  */
	...
	/** Recursively applies the given function to the elements of this collection and a folded value,
	  ...
	  * @return [[net.noresttherein.slang.collection.foldingMethods.foldLeftSome foldLeftSome]]`(start)(op)`.
	  */
...
/** An extension method [[net.noresttherein.slang.collection.BuilderExtension.mapInput mapInput]]
  * which adapts the builder to a new element type.
  */
