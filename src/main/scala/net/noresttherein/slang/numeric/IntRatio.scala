...
/** Simple implementation of rational numbers (fractions of integer values). The fraction is always
  ...
  * see [[net.noresttherein.slang.numeric.IntRatio.apply(numerator:Int, denominator:Int)* IntRatio()]].
...
/** Companion object for the [[net.noresttherein.slang.numeric.IntRatio! IntRatio]] class representing rational numbers
...
//		new IntRatio(numerator.toLong << 32 | denominator & 0xFFFFFFFFL)
	...
	/** Creates a rational number in the canonical form. Returned [[net.noresttherein.slang.numeric.IntRatio IntRatio]]
	...
	class IntRatioFactory(private val numerator :Int) extends AnyVal {
		...
		/** Divides this `Int` by the argument, creating a [[net.noresttherein.slang.numeric.IntRatio IntRatio]] number
		...
		/** Divides this `Int` by the argument, creating a [[net.noresttherein.slang.numeric.Ratio Ratio]]
