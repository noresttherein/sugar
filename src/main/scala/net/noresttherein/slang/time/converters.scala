...
import net.noresttherein.slang.time.converters.{JavaChronoUnitConverter, JavaClockConverter, JavaDayOfWeekConverter, JavaDurationConverter, JavaInstantConverter, JavaIsoEraConverter, JavaLocalDateConverter, JavaLocalDateTimeConverter, JavaLocalTimeConverter, JavaMonthConverter, JavaMonthDayConverter, JavaOffsetDateTimeConverter, JavaOffsetTimeConverter, JavaPeriodConverter, JavaTemporalFieldConverter, JavaYearConverter, JavaYearMonthConverter, JavaZonedDateTimeConverter, JavaZoneIdConverter, JavaZoneOffsetConverter, ScalaDurationConverter}
import net.noresttherein.slang.typist.Rank
