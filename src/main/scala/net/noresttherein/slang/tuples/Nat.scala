...
import net.noresttherein.slang.tuples.Nat.++
...
/** Type level implementation of natural numbers used to index variable length tuples. In order to identify the type
  ...
  * [[net.noresttherein.slang.tuples.Nat._0 Nat._0]] is used to denote zero, while every positive value is represented by
  * recursively applying successor subclass [[net.noresttherein.slang.tuples.Nat.++ Nat.++]]
