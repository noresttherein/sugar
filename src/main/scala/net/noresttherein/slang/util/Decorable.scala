package net.noresttherein.slang.util
...
/** Mixin trait for any interface `Self` we might want to decorate. It is aware what its decorator is.
  ...
  * implementation on property [[net.noresttherein.slang.util.Decorable.self self]]. This object can be then passed
  ...
  * function is passed as an argument to [[net.noresttherein.slang.util.Decorable.decorate decorate]] method
  ...
  * @see [[net.noresttherein.slang.util.Decorable.AbstractDecorable]]
  * @see [[net.noresttherein.slang.util.Decorable.Decorator]]
  */
...
object Decorable {
	...
	trait Decorator[Self <: Decorable[Self]] extends Decorable[Self] { this :Self =>
		...
		/** Equals [[net.noresttherein.slang.util.Decorable.Decorator.decorated decorated]]`.`[[net.noresttherein.slang.util.Decorable.self self]]. */
		override val self :Self = decorated.self

		/** Delegates to [[net.noresttherein.slang.util.Decorable.Decorator.decorated decorated]]`.`[[net.noresttherein.slang.util.Decorable.decorate decorate]].  */
