...
/** Atomic variables providing several 'test-and-set' operations. They are very similar
  * to [[net.noresttherein.slang.vars.Volatile Volatile]], but unlike them, and unlike their Java counterparts,
  ...
  * unless done as a part of one of the atomic operations defined by [[net.noresttherein.slang.vars.InOut InOut]]
  * interface.
  *
...
/** Factory of [[net.noresttherein.slang.vars.Atomic atomic]] variables.
