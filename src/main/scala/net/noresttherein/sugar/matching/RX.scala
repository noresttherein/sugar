...
/** A regular expression and a building block providing syntax for creating larger regular expressions.
  ...
  * (through the [[net.noresttherein.sugar.matching.RX$#apply(pattern:String,groups:String*)* RX(pattern)]] method)
  * wherever this would improve readability.
  *
  * @see [[net.noresttherein.sugar.matching.RX$ RX object]]
...
sealed abstract class RX extends Serializable {
	...
	/** A regular expression greedily matching this expression at least the given number of times: `(this){min,}`.
	  ...
	  *            [[net.noresttherein.sugar.matching.RX.RepeatAtLeast.-* -*]] method available by an implicit conversion:
	  *            `alpha * 3.-*`.
	  */
	...
	/** A named, capturing group matching this expression: `(?&lt;name&gt;this)`. Matched fragment can be referenced with
	  * [[net.noresttherein.sugar.matching.RX$.group RX.group(name)]].
	  */
...
object RX {
	...
	implicit class RXInterpolation(val sc :StringContext) extends AnyVal {
		...
		/** Creates a regular expression [[net.noresttherein.sugar.matching.RX RX]] object from an interpolated ''raw''
	...
	/** Adapts a regular expression given as a string to an [[net.noresttherein.sugar.matching.RX RX]] instance.
	...
	/** A back-reference for a group captured by a preceding fragment of a regular expression as created by the
	  * [[net.noresttherein.sugar.matching.RX#group RX.group]] method.
	...
	/** A regular expression turning on the `UNIX_LINES` ('d') flag for the remainder of the expression.
	  * This will treat only the new line character ([[net.noresttherein.sugar.matching.RX$.NL NL]] = '\n')
	...
	/** A regular expression turning on the `DOTALL` ('s') flag for the remainder of the expression.
	  * It will make the special '.' character ([[net.noresttherein.sugar.matching.RX$.`.` `.`]]) match also the
	...
	/** A regular expression turning on the `MULTILINE` ('m') flag for the remainder of the expression.
	  * This will make the special characters `'^'` ([[net.noresttherein.sugar.matching.RX.`^` `\^`]]) and `'$'`
	  * ([[net.noresttherein.sugar.matching.RX$.`$` `$`]]) match a beginning and end of any line of input, respectively.
	...
	/** A regular expression turning on the `CASE_INSENSITIVE` ('i') flag for the remainder of the expression.
	  ...
	  * @see [[net.noresttherein.sugar.matching.RX$.uCase uCase]]
	  * @see [[net.noresttherein.sugar.matching.RX$.uNoCase uNoCase]]
	  * @see [[net.noresttherein.sugar.matching.RX.apply(flags:net\.noresttherein\.sugar\.matching\.RX\.Flag\*)* RX.apply]]
	  */
	...
	/** A regular expression turning on the `CASE_INSENSITIVE` and `UNICODE_CASE` ('iu') flags for the remainder of
	  ...
	  * @see [[net.noresttherein.sugar.matching.RX$.NoCase NoCase]]
	  * @see [[net.noresttherein.sugar.matching.RX$.uCase uCase]]
	  * @see [[net.noresttherein.sugar.matching.RX.apply(flags:net\.noresttherein\.sugar\.matching\.RX\.Flag\*)* RX.apply]]
	  */
	...
	/** A regular expression turning on the `UNICODE_CASE` ('u') flag for the remainder of the expression.
	  * When used in conjunction with the [[net.noresttherein.sugar.matching.RX$.NoCase NoCase]] ('i') flag,
	...
	/** A regular expression turning on the `UNICODE_CHARACTER_CLASS` ('U') flag for the remainder of the expression.
	  ...
	  * ([[net.noresttherein.sugar.matching.RX$.uCase uCase]]). POSIX character classes are not used by the `RX`
	...
	/** A regular expression turning on the `COMMENTS` ('x') flag for the remainder of the expression.
	  ...
	  * @see [[net.noresttherein.sugar.matching.RX.apply(flags:net\.noresttherein\.sugar\.matching\.RX\.Flag\*)* RX.apply]]
	  * @see [[net.noresttherein.sugar.matching.RX.\#\# RX.##]]
	  * @see [[net.noresttherein.sugar.matching.RX.comment comment]]
	  */
	...
	/** A regular expression matching exactly one character, representable as a complex character class `[...]`.
	  * In addition to the standard [[net.noresttherein.sugar.matching.RX RX]] methods, it provides a way
	  ...
	  * @see [[net.noresttherein.sugar.matching.RX.CharLiteral CharLiteral]]
	  */
	...
	/** Adds a `-*` method to an `Int`, producing an [[net.noresttherein.sugar.matching.RX.AtLeast AtLeast]] instance. */
