...
class ClassNameMethods[T](private val self :T) extends AnyVal {
	...
	/** Same as the default `Object.toString`, but uses
	  * `this.`[[net.noresttherein.sugar.prettyprint.ClassNameMethods.innerClassName innerClassName]]
	...
	/** Same as the default `Object.toString`, but uses
	  * `this.`[[net.noresttherein.sugar.prettyprint.ClassNameMethods.localClassName localClassName]]
	  * instead of `this.getClass.getName`.
	  */
	...
	/** Same as the default `Object.toString`, but uses
	  * `this.`[[net.noresttherein.sugar.prettyprint.ClassNameMethods.abbrevClassName abbrevClassName]]
	  * instead of `this.getClass.getName`.
	  */
	...
	/** Same as the default `Object.toString`, but uses
	  * (printable) `this.`[[net.noresttherein.sugar.prettyprint.ClassNameMethods.className className]]
	  * instead of `this.getClass.getName`.
	  */
