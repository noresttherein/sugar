...
//			((new LongInt.shoo(42, 44)).abbrevClassName ?= "n.n.s.p.classNameMethodsSpec.Spec[Long,Int].shoo") &&
	...
	property("className") = {
		((new !@#%^&*-+=<>?/|\:).className ?=
			"net.noresttherein.slang.prettyprint.classNameMethodsSpec.Nest.!@#%^&*-+=<>?/|\\:") &&
			(anonymous.className ?= "net.noresttherein.slang.prettyprint.classNameMethodsSpec.Nest.anon.1") &&
			(singleton.className ?= "net.noresttherein.slang.prettyprint.classNameMethodsSpec.Nest.singleton") &&
			(ByteShort.className ?= "net.noresttherein.slang.prettyprint.classNameMethodsSpec.Spec[Byte,Short]") &&
			(IntInt.className ?= "net.noresttherein.slang.prettyprint.classNameMethodsSpec.Spec[Int,Int]") &&
			(LongInt.className ?= "net.noresttherein.slang.prettyprint.classNameMethodsSpec.Spec[Long,Int]") &&
			(FloatUnit.className ?= "net.noresttherein.slang.prettyprint.classNameMethodsSpec.Spec[Float,Unit]") &&
			(DoubleUnit.className ?= "net.noresttherein.slang.prettyprint.classNameMethodsSpec.Spec[Double,Unit]")  &&
			(CharBool.className ?= "net.noresttherein.slang.prettyprint.classNameMethodsSpec.Spec[Char,Bool]") &&
			((new DoubleUnit.boo).className ?= "net.noresttherein.slang.prettyprint.classNameMethodsSpec.Spec.boo") &&
			//			((new LongInt.shoo(42, 44)).className ?= "net.noresttherein.slang.prettyprint.classNameMethodsSpec.Spec[Long,Int].shoo") &&
