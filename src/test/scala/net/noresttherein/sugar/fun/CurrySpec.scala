...
import net.noresttherein.sugar.funny.Curry
import net.noresttherein.sugar.funny.Curry.Curried
...
//	import net.noresttherein.sugar.funny.Curry.PartiallyApplied.CurryOn
	import Curry.<=>
